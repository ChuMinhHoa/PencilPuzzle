    ...
    public class ModalNewObjectContext
    {
            ...
            public UniTask Initialize(Memory<object> args)
            {
                ...
                if (!string.IsNullOrEmpty(temp))
                {
                    ...
                    if(objectType == "Booster")
                    {
                        ...
                        BoosterType = (BoosterType)Enum.Parse(typeof(BoosterType), extracted);
                        IsBooster = true;
                    }
                }
        ...
        public class UIView : IAView
        {
            ...
            public UniTask Initialize(Memory<object> args)
            {
                ...
                if (!string.IsNullOrEmpty(temp))
                {
                    ...
                    {
                        string extracted = temp.Substring(temp.IndexOf('_') + 1);
                        BoosterType boosterType = (BoosterType)Enum.Parse(typeof(BoosterType), extracted);
                        BoosterData boosterData = ItemGlobalConfig.Instance.GetBoosterData(boosterType);
                        ObjNameTxt.text = boosterData.BoosterName;
        ...
        public class UIPresenter : IAPresenter, IModalLifecycleEventSimple
        {
            ...
            public async UniTask Initialize(Memory<object> args)
            {
                ...
                View.ClaimBtn.SetOnClickDestination(() => OnButtonCloseClick().Forget());
            }
