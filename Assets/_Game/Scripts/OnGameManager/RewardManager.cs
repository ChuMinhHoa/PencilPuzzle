...
namespace _Game.Scripts.Manager
{
    public class RewardManager : Singleton<RewardManager>
    {
        ...
        {
            PlayerResourceManager.Instance.AddResourceValue(gameResource.Type, gameResource.SpecificType, gameResource.Value.Value);
        }
        ...
        void LoadLifeInfo()
        {
            ...
            PlayerResourceManager.Instance.AddResourceValue(ResourceType.Currency, (int)CurrencyType.Life, toAddLifeCount);
        }
