...
namespace _Game.Scripts.Manager
{
    public class PlayerResourceManager : Singleton<PlayerResourceManager>
    {
        ...
        {
            gameResources = ResourceData.Instance.Resources;
            UsedBoosterOnTut = ResourceData.Instance.UsedBoosterOnTut;
            LifeSave = ResourceData.Instance.LifeSave;
            PurchasedPacks = ResourceData.Instance.PurchasedPacks;
        }
        ...
        public GameResource GetResource(ResourceType type, int specificType)
        {
            ...
            {
                GameResource resource = gameResources[i];
